...
docker run -e GIT_AUTHOR_NAME -e GIT_AUTHOR_EMAIL -e GIT_COMMITTER_NAME -e GIT_COMMITTER_EMAIL -e ALTERNATE_COMPOSER_PATH -e REPO_TOKEN -e LICENCE_KEY -e USER_TOKEN -e PROJECT_URL -e USE_CLOSE_NO_LONGER_RELEVANT ghcr.io/violinist-dev/update-check-runner:$1-multi-composer-$2 >> $GITHUB_OUTPUT
echo -e "\n" >> $GITHUB_OUTPUT
